...
public class AddImageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set User current DP in ImageView (if uploade already)
        //Regular Uri
        Picasso.with(AddImageActivity.this).load(uri).into(imageViewUploadPic);
        ...
        if (uriImage != null){
            ...
            fileReference.putFile(uriImage).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    Intent intent = new Intent(AddImageActivity.this, UserProfileActivity.class);
            ...
            progressBar.setVisibility(View.GONE);
            Toast.makeText(AddImageActivity.this, "No Image was Selected!", Toast.LENGTH_SHORT).show();
        }
    }

    //Obtain File Extenseion of the image
